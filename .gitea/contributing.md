...
Thus, 3rd party plugins are not supported, instead all plugins are part of Voltage itself.
...
-   Now paste the following into the console: `Voltage.Webpack.wreq.m[447887].toString()` (Changing the number to your ID)
