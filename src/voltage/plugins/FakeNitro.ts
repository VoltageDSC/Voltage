...
export default definePlugin({
    ...
    getStickerLink(stickerId: string) {
        return `https://media.discordapp.net/stickers/${stickerId}.png?size=${Settings.plugins["Fake Nitro"].stickerSize}`;
    },
    ...
    async sendAnimatedSticker(stickerLink: string, stickerId: string, channelId: string) {
        ...
        const resolution = Settings.plugins["Fake Nitro"].stickerSize;
    ...
    start() {
        const settings = Settings.plugins["Fake Nitro"];
