...
export default definePlugin({
    name: "PronounDB",
    authors: [Devs.Sappy],
    description: "Shows you the pronoun of a user right next to their name. Pronouns by PronounDB.",
    patches: [
        // Patch the chat timestamp element
        {
            ...
            replacement: {
                ...
                replace: "[$1, Voltage.Plugins.plugins.PronounDB.PronounsChatComponent(e)]"
            }
        },
        // Hijack the discord pronouns section (hidden without experiment) and add a wrapper around the text section
        {
            ...
            replacement: {
                ...
                replace: "$<fullProps>&&Voltage.Plugins.plugins.PronounDB.PronounsProfileWrapper($<PronounComponent>,$<pronounProps>,$<fullProps>)"
            }
        },
