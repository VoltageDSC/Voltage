...
const PlatformIndicator = ({ user, inline = false, marginLeft = "4px" }: { user: User; inline?: boolean; marginLeft?: string; }) => {
    ...
    return (
        <div
            className="voiltage-platform-indicator"
            style={{
                marginLeft,
                gap: "4px",
...
export default definePlugin({
    ...
    authors: [Devs.Sappy],
    dependencies: ["Message Decorations API", "Member List Decorators API"],

    start() {
        const settings = Settings.plugins["Platform Indicators"];
