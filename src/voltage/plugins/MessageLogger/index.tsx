...
export default definePlugin({
    ...
    handleDelete(cache: any, data: { ids: string[], id: string; }, isBulk: boolean) {
        try {
            ...
            const { ignoreBots, ignoreSelf } = Settings.plugins["Message Logger"];
            ...
            replacement: [
                {
                    ...
                    replace:
                        ...
                        "   cache = Voltage.Plugins.plugins[\"Message Logger\"].handleDelete(cache, $1, false);" +
                        "   $2commit(cache);" +
                        "},"
                },
                {
                    ...
                    replace:
                        ...
                        "   var cache = $2getOrCreate($1.channelId);" +
                        "   cache = Voltage.Plugins.plugins[\"Message Logger\"].handleDelete(cache, $1, true);" +
                        "   $2commit(cache);" +
                        "},"
                },
                {
                    ...
                    replace: "$1" +
                        ...
                        "       m.set('editHistory',[...(m.editHistory || []), Voltage.Plugins.plugins[\"Message Logger\"].makeEdit($2.message, m)]) :" +
                        "       m" +
                        ")" +
                        ".update($3"
                }
            ...
            replacement: [
                {
                    ...
                    replace: "$1 (arguments[0].message.editHistory.length > 0 ? arguments[0].message.editHistory.map(edit => Voltage.Plugins.plugins[\"Message Logger\"].renderEdit(edit)) : null), "
                }
            ]
        },
