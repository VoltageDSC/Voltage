...
export default definePlugin({
    ...
    handleCrash(_this: ReactElement & { forceUpdate: () => void; }) {
        ...
        try {
            if (crashCount === 1) maybePromptToUpdate("Uh oh, Discord has just crashed... but good news, there is a Voltage update available that might fix this issue! Would you like to update now?", true);
