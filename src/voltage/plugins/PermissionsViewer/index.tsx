...
export default definePlugin({
    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: "Voltage.Plugins.plugins[\"Permissions Viewer\"].UserPermissions($<guild>,$<guildMember>),",
            },
        },
        {
            ...
            replacement: {
                ...
                replace: (mod, user, guildId) => {
                    ...
                    if (rolesItem) {
                        mod = mod.replace(RegExp(`(?<=children:\\[${rolesItem[0]},.{0,10})(?=\\])`), `,Voltage.Plugins.plugins["Permissions Viewer"].MenuItem(${guildId},${user}.id,${MenuItemParentType.User})`);
                    }
        ...
        },
        {
            ...
            replacement: {
                ...
                replace: "Voltage.Plugins.plugins[\"Permissions Viewer\"].MenuItem($<guild>.id),"
            }
        },
        ...[
    ...
    MenuItem(guildId: string, id?: string, type?: MenuItemParentType) {
        ...
        return (
            <Menu.MenuItem
                id="permviewer-permissions"
                key="permviewer-permissions"
                label="Permissions"
                action={async () => {
